    ...
    generateImage() {
      ...
      switch (automaticOption) {
        case 0: {
          let randomTypeAnime =
            this.animeTypeList[
              generateRamdonNumber(this.animeTypeList.length, 0)
            ];
          ...
          let ouput = {
            uri: url,
            altNameAnime: String(randomTypeAnime + randomNumerItem),
          };
          return ouput;
        }
        case 1: {
          let randomNumerItem = generateRamdonNumber(50, 1);
          return {
            uri: `https://pic.re/image/${randomNumerItem}`,
            altNameAnime: "pic.re random",
          };
        }
        default: {
